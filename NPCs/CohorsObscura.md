...
| --------------- | ------------------------- |
| **Tożsamość**   | Nefilim                   |
| **Motyw**       | Chęć przetrwania         |
| **Pochodzenie** | Twierdza Nefilim w górach |
| **Poziom**      | LV 30                     |
| **Typ**         | Humanoid                  |
...
| Broń                        | Formuła trafienia | Obrażenia | Typ                                  |
| --------------------------- | ----------------- | --------- | ------------------------------------ |
| **Krótki kulomiot Nefilim** | (DEX + WLP) +5    | (HR + 10) | Physical + 5 Fire |
...
| ---------------------------- | ----------------- | --------- | ------------------------ |
| **Krótki kulomiot Nefilim**  | (DEX + WLP) +5    | (HR + 10) | Physical + 5 Fire        |
| **Strzelba Nefilim**         | (DEX + WLP) +6    | (HR + 9)  | Physical                 |
| **Miotacz płomieni Nefilim** | (DEX + MIG) +5    | (HR + 9)  | Fire (Multi (3))         |
